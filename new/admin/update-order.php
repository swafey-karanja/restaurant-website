...
if(isset($_GET['id']))
{
    ...
    else
    {
        ...
        header('location:'.'http://localhost/new/admin/manage-order.php');
    }
}
else
{
...
<table class="tbl-30">
    ...
    <tr>
        <td colspan="2">
            ...
            <input type="submit" name="submit" value="Update Order" class="btn-delete">
        </td>
    </tr>
</table>
...
<?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                if($res2==true)
                {
                    ...
                    header('location:'.'http://localhost/new/admin/order-manage.php');
                }
                else
                {
                    //Failed to Update
